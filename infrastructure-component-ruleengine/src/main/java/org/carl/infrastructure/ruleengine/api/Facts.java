...
public class Facts implements Iterable<Fact<?>> {
    ...
    /**
     * Get the value of a fact by its name. This is a convenience method provided as a short version
     * of {@code getFact(factName).getValue()}.
     *
     * @param factName name of the fact, must not be null
     * @param <T> type of the fact's value
     * @return the value of the fact having the given name, or null if there is no fact with the
     *     given name
     */
    ...
    /**
     * Return a copy of the facts as a map. It is not intended to manipulate facts outside of the
     * rules engine (aka other than manipulating them through rules).
     *
    ...
    /**
     * Return an iterator on the set of facts. It is not intended to remove facts using this
     * iterator outside of the rules engine (aka other than doing it through rules)
     *
