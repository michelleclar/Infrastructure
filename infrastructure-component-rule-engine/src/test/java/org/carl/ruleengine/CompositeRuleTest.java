...
import org.carl.infrastructure.ruleengine.core.AllRules;
import org.carl.infrastructure.ruleengine.core.AnyRules;
...
public class CompositeRuleTest {
    ...
    private Rule assembleRules(int fizzPriority, int BuzzPriority, int FizzBuzzPriority) {
        ...
        Rule fizzBuzzRule =
                AllRules.allOf(fizzRule, buzzRule).name("fizzBuzzRule").priority(FizzBuzzPriority);
