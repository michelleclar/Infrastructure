...
### 脱敏工具（包 `org.carl.infra.utils.desensitization`）
...
### 数据结构（包 `org.carl.infra.utils.struct`）
...
```java
import org.carl.infra.utils.StringUtils;
import org.carl.infra.utils.CollectionUtils;
...
```java
import org.carl.infra.utils.LogUtils;
...
```java
import org.carl.infra.utils.UrlParser;
...
```java
import org.carl.infra.utils.desensitization.MaskEmailAlgorithm;
import org.carl.infra.utils.desensitization.MaskPhoneNumberAlgorithm;
import org.carl.infra.utils.desensitization.MaskMiddleAlgorithm;
...
```java
import org.carl.infra.utils.desensitization.IDesensitizationAlgorithm;
...
```java
import org.carl.infra.utils.struct.DAG;
...
```java
import org.carl.infra.utils.struct.LinkedTable;
