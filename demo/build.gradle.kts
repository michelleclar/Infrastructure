...
dependencies {
    ...
    implementation(libs.infra.component.dto)
    implementation(libs.infra.component.authorization)
    implementation(libs.infra.component.cache)
    implementation(libs.infra.component.quarkus.persistence)
    implementation(libs.infra.component.search)
    implementation(libs.infra.component.web)
    implementation(libs.infra.component.qdrant.grpc)
    implementation(libs.infra.component.embedding.grpc)
    implementation(libs.infra.component.workflow)
    implementation(libs.infra.component.statemachine)
    implementation(libs.infra.component.metrics)
    implementation(libs.infra.component.mq)
    implementation(libs.infra.component.redis)
    implementation(libs.infra.component.ruleengine)
    jooqGenerator(libs.infra.component.persistence.jooq)
