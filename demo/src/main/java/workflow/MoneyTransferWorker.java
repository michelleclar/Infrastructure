...
@ApplicationScoped
public class MoneyTransferWorker implements IWorkerAbility {
    ...
    public String getWorker() {
        return Shared.MONEY_TRANSFER_TASK_QUEUE;
    }

    @Override
    public Class<?>[] getWorkflowImplClasses() {
        return new Class[] {MoneyTransferWorkflowImpl.class};
    }

    @Override
    public Object[] getActivityImplInstances() {
        return new Object[] {new AccountActivityImpl()};
    }
}
// @@@SNIPEND
