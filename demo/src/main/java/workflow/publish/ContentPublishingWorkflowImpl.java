...
public class ContentPublishingWorkflowImpl implements IContentPublishingWorkflow {

    public final ContentPublishingActivity activity =
            ActivityStubsProvider.getWarehouseActivities();
    ...
    public ContentPublishingWorkflowImpl() {
        StateMachineBuilder<
                        ContentPublishingStatusEnum,
                        ContentPublishingEventEnum,
                        ContentPublishingContext>
    ...
    @Override
    public void publish(ContentPublishingContext context, ContentPublishingEventEnum event) {
        ContentPublishingStatusEnum currentStatus = activity.currentStatus(context);
        if (stateMachine.verify(currentStatus, event)) {
            ContentPublishingStatusEnum afterStatus =
                    stateMachine.fireEvent(currentStatus, event, context);
            System.out.println(afterStatus);
        }
    }

    @Override
    public ContentPublishingStatusEnum queryCurrentStatus(ContentPublishingContext context) {
        return activity.currentStatus(context);
    }
    ...
    public void externalTransition(
        ...
        stateMachine
                ...
                .when(checkIsReady())
                .perform(ActivityStubsProvider.wrapper(activity::submitForReview));
        ...
        stateMachine
                ...
                .perform(ActivityStubsProvider.wrapper(activity::publishContent));
        // 提交审核 审核拒绝 已经拒绝
        stateMachine
                .externalTransition()
                .from(ContentPublishingStatusEnum.SUBMITTED)
                ...
                .perform(ActivityStubsProvider.wrapper(activity::rejectContent));
        // 已经拒绝 撤销拒绝 提交审核
        stateMachine
                .externalTransition()
