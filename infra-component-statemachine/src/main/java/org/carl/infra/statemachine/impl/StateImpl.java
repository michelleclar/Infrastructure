...
import org.carl.infra.statemachine.Transition;
import org.carl.infra.statemachine.Visitor;
...
public class StateImpl<S, E, C> implements State<S, E, C> {
    ...
    public Transition<S, E, C> addTransition(
            E event, State<S, E, C> target, TransitionType transitionType) {
    ...
    @Override
    public List<Transition<S, E, C>> addTransitions(
            E event, List<State<S, E, C>> targets, TransitionType transitionType) {
    ...
    public boolean equals(Object anObject) {
        if (anObject instanceof State) {
            ...
            if (this.stateId.equals(other.getId())) return true;
        }
        return false;
    }
