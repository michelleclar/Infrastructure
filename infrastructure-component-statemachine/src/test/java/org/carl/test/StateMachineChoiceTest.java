...
public class StateMachineChoiceTest {
    ...
    /**
     * 测试选择分支，针对同一个事件：EVENT1 if condition == "1", STATE1 --> STATE1 if condition == "2" , STATE1 -->
     * STATE2 if condition == "3" , STATE1 --> STATE3
     */
    @Test
    public void testChoice() {
        StateMachineBuilder<StateMachineTest.States, StateMachineTest.Events, Context> builder =
        ...
        StateMachine<StateMachineTest.States, StateMachineTest.Events, Context> stateMachine =
                builder.build("ChoiceConditionMachine");
        StateMachineTest.States target1 =
        ...
        StateMachineTest.States target2 =
                stateMachine.fireEvent(
                        StateMachineTest.States.STATE1,
                        StateMachineTest.Events.EVENT1,
                        new Context("2"));
        Assertions.assertEquals(StateMachineTest.States.STATE2, target2);
        StateMachineTest.States target3 =
                stateMachine.fireEvent(
                        StateMachineTest.States.STATE1,
                        StateMachineTest.Events.EVENT1,
                        new Context("3"));
