 ...
 * org.carl.infra.workflow.spi.NodeHandler} can be set via {@link #type(String)} or its
 ...
 * org.carl.infra.workflow.definition.NodeDefinition#label()} when the parent {@link
