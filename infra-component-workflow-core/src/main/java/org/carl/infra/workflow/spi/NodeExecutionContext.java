...
public interface NodeExecutionContext {
     ...
     * org.carl.infra.workflow.definition.WorkflowDefinition#id()} value. Stable across all
    ...
    default java.util.List<org.carl.infra.workflow.definition.ExecutionRecord>
            executionRecords() {
