 ...
 *
 * <p>Holds the node type discriminator (see {@link org.carl.infra.workflow.spi.NodeTypes})
 * and a property map that is serialised into the {@link
 * org.carl.infra.workflow.definition.NodeDefinition#config()} JSON field by {@link
 * FlowDef#build()}.
 *
