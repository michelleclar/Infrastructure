...
>
> **零 Temporal 依赖**。只写流程定义、做离线校验或开发自定义节点类型：依赖本模块即可。要在 Temporal 上真正跑起来，见 [infra-component-workflow-temporal](../infra-component-workflow-temporal/README.md)。
...
要在 Temporal 上运行由本模块定义的 `WorkflowDefinition`，请参阅 [infra-component-workflow-temporal/README.md](../infra-component-workflow-temporal/README.md)。
