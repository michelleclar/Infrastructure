package org.carl.infra.search.plugins.es.core.action;
...
import org.carl.infra.search.plugins.es.core.utils.ElasticsearchClientToolUtils;
        ...
        public <T> List<T> fetchOf(Class<T> clazz) {
            try {
                SearchResponse<T> search =
                        this.search.esClient.search(this.search.builder.build(), clazz);
