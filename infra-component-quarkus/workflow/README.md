# infra-component-quarkus / workflow

把通用 Temporal 工作流引擎（`infra-component-workflow-temporal`）接入 Quarkus CDI 应用。
...
> [`infra-component-workflow-temporal/README.md`](../../infra-component-workflow-temporal/README.md)。
> 本模块只讲 **CDI 接线**。
...
// build.gradle.kts
dependencies {
    implementation(project(":infra-component-quarkus:workflow"))
}
```
...
```properties
quarkus.log.category."org.carl.infra.workflow".level=DEBUG
```
