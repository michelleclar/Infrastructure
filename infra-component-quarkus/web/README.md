...
// build.gradle.kts
dependencies {
    implementation(project(":infra-component-quarkus:web"))
}
```
...
此外还依赖 `:infra-component-utils`（实现依赖，不传递）。
...
`org.carl.infra.component.web.config.WebConfig`。
...
包路径：`org.carl.infra.component.web.config.exception` /
`org.carl.infra.component.web.config.global`
...
包路径：`org.carl.infra.component.web.config`
/ `org.carl.infra.component.web.config.global`
...
包路径：`org.carl.infra.component.web.annotations` /
`org.carl.infra.component.web.annotations.interceptor`
...
包路径：`org.carl.infra.component.web.runtime` /
`org.carl.infra.component.web.ability`
...
类：`org.carl.infra.component.web.filter.RootFilter`（`@ApplicationScoped`）
...
接口：`org.carl.infra.component.web.ability.JacksonAbility`
...
`JSON.JSON`（`org.carl.infra.component.web.config.JSON`）是实现了 `JacksonAbility` 的枚举单例，可在静态上下文中直接使用：
...
类：`org.carl.infra.component.web.utils.HClientBuilder` /
`org.carl.infra.component.web.utils.HClient`
...
类：`org.carl.infra.component.web.config.StatusType`
