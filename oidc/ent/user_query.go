...
func (uq *UserQuery) FirstID(ctx context.Context) (id int16, err error) {
	var ids []int16
...
func (uq *UserQuery) FirstIDX(ctx context.Context) int16 {
...
func (uq *UserQuery) OnlyID(ctx context.Context) (id int16, err error) {
	var ids []int16
...
func (uq *UserQuery) OnlyIDX(ctx context.Context) int16 {
...
func (uq *UserQuery) IDs(ctx context.Context) (ids []int16, err error) {
...
func (uq *UserQuery) IDsX(ctx context.Context) []int16 {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (uq *UserQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(user.Table, user.Columns, sqlgraph.NewFieldSpec(user.FieldID, field.TypeInt16))
	_spec.From = uq.sql
