...
import org.carl.infra.ruleengine.core.*;
...
public class RuleEngineTest {
    ...
    public void testFizzBuzz() {
        ...
        Rule fizzRule =
                new DefaultRule(
                        facts -> (int) facts.get("number") % 3 == 0,
                        facts -> System.out.print("Fizz"));
        Rule buzzRule =
                new DefaultRule(
                        facts -> (int) facts.get("number") % 5 == 0,
                        facts -> System.out.print("Buzz"));
        Rule fizzBuzzRule = AllRules.allOf(fizzRule, buzzRule);
        Rule NonFizzBuzzRule =
                new DefaultRule(
                        facts -> true, facts -> System.out.print((int) facts.get("number")));
