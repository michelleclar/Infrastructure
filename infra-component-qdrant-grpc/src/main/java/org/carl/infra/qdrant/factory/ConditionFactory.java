package org.carl.infra.qdrant.factory;
...
public final class ConditionFactory {
                ...
                .setField(
                        FieldCondition.newBuilder()
                                ...
                                .setMatch(
                                        Match.newBuilder()
                                                .setIntegers(
                                                        RepeatedIntegers.newBuilder()
                                                                .addAllIntegers(values)
                                                                .build())
                                                .build())
                                .build())
                .build();
     ...
     * @return a new instance of {@link Condition}
     */
    public static Condition geoRadius(
            String field, double latitude, double longitude, float radius) {
        return Condition.newBuilder()
                .setField(
                        FieldCondition.newBuilder()
                                .setKey(field)
