...
public class MoneyTransferWorkflowImpl implements MoneyTransferWorkflow {
    ...
    private final RetryOptions retryoptions =
            RetryOptions.newBuilder()
                    ...
                    .setMaximumInterval(
                            Duration.ofSeconds(20)) // Do not exceed 20 seconds between retries
    ...
    private final ActivityOptions defaultActivityOptions =
            ActivityOptions.newBuilder()
                    ...
                    .setStartToCloseTimeout(
                            Duration.ofSeconds(2)) // Max execution time for single Activity
                    .setScheduleToCloseTimeout(
                            Duration.ofSeconds(
                                    5000)) // Entire duration from scheduling to completion
    ...
    public void transfer(TransactionDetails transaction) {
        ...
        try {
            ...
            accountActivityStub.deposit(
                    destinationAccountId, transactionReferenceId, amountToTransfer);
