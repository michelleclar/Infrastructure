...
public class PulsarProducer<T> implements IProducer<T> {
    ...
    private SendResult<T> wrapperSuccess(MessageBuilder.Message<T> message) {
        return new SendResult<>() {

            @Override
            public MessageBuilder.Message<T> getMessage() {
                return message;
            }
    ...
    private SendResult<T> wrapperFailure(Throwable ex, MessageBuilder.Message<T> message) {
        return new SendResult<>() {
