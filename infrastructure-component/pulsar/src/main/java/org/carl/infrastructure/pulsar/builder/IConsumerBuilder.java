...
public interface IConsumerBuilder<T> extends Cloneable {
    ...
    IConsumerBuilder<T> subscriptionType(IConsumer.SubscriptionType subscriptionType);

    IConsumerBuilder<T> subscriptionMode(IConsumer.SubscriptionMode subscriptionMode);

    IConsumerBuilder<T> messageListener(IConsumer.MessageListener<T> messageListener);
